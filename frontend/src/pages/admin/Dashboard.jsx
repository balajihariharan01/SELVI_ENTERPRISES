        ...
        <div className="stats-row">
          ...
          >
            ...
            <div className="stat-content">
              <h3><AnimatedCounter value={stats?.totalOrders || 0} duration={1.2} /></h3>
              <p>Total Orders</p>
            </div>
          ...
          >
            ...
            <div className="stat-content">
              <h3><AnimatedCounter value={stats?.pendingOrders || 0} duration={1.2} delay={0.1} /></h3>
              <p>Pending Orders</p>
            </div>
            <div className="stat-decoration"></div>
          </motion.div>
          ...
          >
            ...
            <div className="stat-content">
              <h3><AnimatedCounter value={stats?.totalProducts || 0} duration={1.2} delay={0.2} /></h3>
              <p>Total Products</p>
            </div>
            <div className="stat-decoration"></div>
          </motion.div>
          ...
          <motion.div 
            className="stat-card stat-customers"
            variants={statCardVariants}
            initial="initial"
            animate="animate"
            whileHover="hover"
          ...
          >
            ...
            <div className="stat-content">
              <h3><AnimatedCounter value={stats?.totalCustomers || 0} duration={1.2} delay={0.3} /></h3>
              <p>Total Customers</p>
            </div>
            <div className="stat-decoration"></div>
          </motion.div>
